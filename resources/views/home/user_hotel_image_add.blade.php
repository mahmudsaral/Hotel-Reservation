...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Hotel : {{$data->title}}</h3>
    ...
    <div class="row">
        <div class="col-sm-12 col-xs-12">
            <form role="form" action="{{route('user_image_store',['hotel_id'=>$data->id])}}" method="post"
        ...
        <table id="myTable" class="table table-bordered table-striped">
            ...
            @foreach ($images as $rs)
                ...
                <tr>
                    ...
                    <td><a href="{{route('user_image_delete',['id'=> $rs->id,'hotel_id'=>$data->id])}}"

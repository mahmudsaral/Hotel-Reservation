                                        ...
                                        <div class="table-responsive m-t-40">
                                            <table id="myTable" class="table table-bordered table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{!!  $rs->answer !!}</td>
                                                    <td>{{ $rs->status }}</td>
                                                    <td><a href="{{route('admin_faq_edit',['id'=> $rs->id])}}"> <ion-icon name="create-outline"></ion-icon> <img src="{{asset('assets/admin/images')}}/editicon.png" height="40"></a></td>
                                                    <td><a href="{{route('admin_faq_delete',['id'=> $rs->id])}}" onclick="return confirm('Delete! Are you sure ?')"> <img src="{{asset('assets/admin/images')}}/deleteicon.jpg" height="40" ></a></td>
                                                </tr>
